...
function Navbar() {
  ...
  const [showSearch, setShowSearch] = useState(false); // Add new state for search submenu
          ...
          <div>
            ...
            <ul className="flex items-center justify-center gap-1">
              ...
              {[
                ...
                { id: "prayer", label: " أوقات صلاة", link: "/prayer" },
              ].map((category) => (
                <li
                  key={category.id}
                  className="text-white rounded-sm px-2 py-2 hover:text-black hover:bg-white dark:hover:bg-slate-700 dark:hover:text-white"
                >
                  <Link to={category.link}>{category.label}</Link>
                </li>
              ))}
              {/* Region Submenu */}
              <div className="relative static px-1">
                <button
              ...
              {[
                ...
                <li
                  key={category.id}
                  className="text-white rounded-sm px-3 py-2 hover:text-black hover:bg-white dark:hover:bg-slate-700 dark:hover:text-white"
                >
                  <Link to={category.link}>{category.label}</Link>
                </li>
              ))}
              ...
              >
                <svg
                  ...
                  width="20px"
                  className="fill-white hover:fill-black dark:hover:fill-white"
                >
            ...
            <div
              className={`absolute left-0 w-full bg-gradient-to-r from-red-900/90 to-black dark:from-slate-900 dark:to-black transform transition-all duration-300 origin-top border-t border-red-800 ${
                showSearch ? "scale-y-100 opacity-100" : "scale-y-0 opacity-0"
              }`}
              style={{
                position: "fixed",
                left: "0",
            ...
            >
              <div className="container mx-auto flex justify-center items-center gap-16 py-6">
                <div className="w-[600px] flex rounded-xl border border-white/40 overflow-hidden">
                  <input
                  ...
                  >
                    <button
                      type="button"
                      className="flex items-center justify-center bg-red-950 hover:bg-red-900 dark:hover:bg-gray-900 px-6 py-4"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 192.904 192.904"
